...
# imports would normally go at the top of the file,
# but I'm putting this here to show that I imported
# it specifically for this part of the problem
import string

print("Starts between C and G, inclusive:")
c = [x.name for x in humans if x.name[0] in string.ascii_uppercase[2:7]]
print(c)
